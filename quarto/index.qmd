...
- Microscopy core + delivery folders
- Import
- Publication
- Analysis w/ QuPath, Python, ImageJ/Fiji

# Day 1: Viewing images in OMERO web

## Browsing image names
:::: {.columns style='display: flex'}
::: {.column width="60%" style='display: flex; justify-content: left; align-items: center;'}
...
:::
::: {.column width="40%" style='display: flex; justify-content: center;'}

![](visuals/dataset_hierarchy.png){fig-alt="Dataset hierarchy list"} 

:::
:::: 

## Browsing image thumbnails
...
## Searching tags
8. Click the newly-added Metaphase Tag: ![](visuals/metaphase_tag.png){fig-alt="metaphase tag" width=150} in the right-hand panel. This will browse by Tags to show all Images with this Tag, be those your images or images of your colleagues. 
...
![](visuals/search_scope.png){fig-alt="group and owner dropdowns for search" fig-align="center" width=400}
...
![](visuals/group_selection.png){fig-alt="group and user selection dropdown" fig-align="center" width=400}
...
![](visuals/preview_histogram.png){fig-alt="Preview viewer with channels adjusted and histogram"} 
...
## Mouseover pixel intensities in OMERO.iviewer
...
## Changing channels in OMERO.iviewer
